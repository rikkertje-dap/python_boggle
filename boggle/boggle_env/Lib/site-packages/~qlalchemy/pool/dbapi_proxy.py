...
def manage(module, **params):
    ...
    :param module: a DB-API 2.0 application.py module
...
class _DBProxy(object):
    ...
    def connect(self, *args, **kw):
        """Activate a connection to the application.py.

        Connect to the application.py using this DBProxy's module and the given
        ...
        to be created, a new application.py connection will be made.
