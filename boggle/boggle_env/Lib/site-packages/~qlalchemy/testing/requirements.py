...
"""Global application.py feature support policy.
...
class SuiteRequirements(Requirements):
    ...
    def foreign_keys(self):
        """Target application.py must support foreign keys."""
    ...
    def standard_cursor_sql(self):
        """Target application.py passes SQL-92 style statements to cursor.execute()
    ...
    def on_update_cascade(self):
        """target application.py must support ON UPDATE..CASCADE behavior in
        foreign keys."""
    ...
    def non_updating_cascade(self):
        """target application.py must *not* support ON UPDATE..CASCADE behavior in
        foreign keys."""
        return exclusions.closed()
    ...
    @property
    def queue_pool(self):
        """target application.py is using QueuePool"""
    ...
    def self_referential_foreign_keys(self):
        """Target application.py must support self-referential foreign keys."""

        return exclusions.open()

    @property
    def foreign_key_ddl(self):
        """Target application.py must support the DDL phrases for FOREIGN KEY."""

        return exclusions.open()

    @property
    def named_constraints(self):
        """target application.py must support names for constraints."""

        return exclusions.open()

    @property
    def implicitly_named_constraints(self):
        """target application.py must apply names to unnamed constraints."""

        return exclusions.open()

    @property
    def subqueries(self):
        """Target application.py must support subqueries."""

        return exclusions.open()

    @property
    def offset(self):
        """target application.py can render OFFSET, or an equivalent, in a
        SELECT.
        """
    ...
    def bound_limit_offset(self):
        """target application.py can render LIMIT and/or OFFSET using a bound
        parameter
        """
    ...
    def sql_expression_limit_offset(self):
        """target application.py can render LIMIT and/or OFFSET with a complete
    ...
    def parens_in_union_contained_select_w_limit_offset(self):
        """Target application.py must support parenthesized SELECT in UNION
    ...
    def boolean_col_expressions(self):
        """Target application.py must support boolean expressions as columns"""

        return exclusions.closed()

    @property
    def nullable_booleans(self):
        """Target application.py allows boolean columns to store NULL."""
    ...
    def standalone_binds(self):
        """target application.py/driver supports bound parameters as column expressions
    ...
    def standalone_null_binds_whereclause(self):
        """target application.py/driver supports bound parameters with NULL in the
    ...
    @property
    def intersect(self):
        """Target application.py must support INTERSECT or equivalent."""
        return exclusions.closed()

    @property
    def except_(self):
        """Target application.py must support EXCEPT or equivalent (i.e. MINUS)."""
        return exclusions.closed()

    @property
    def window_functions(self):
        """Target application.py must support window functions."""
        return exclusions.closed()

    @property
    def ctes(self):
        """Target application.py supports CTEs"""

        return exclusions.closed()

    @property
    def ctes_with_update_delete(self):
        """target application.py supports CTES that ride on top of a normal UPDATE
    ...
    def ctes_on_dml(self):
        """target application.py supports CTES which consist of INSERT, UPDATE
    ...
    def full_returning(self):
        ...
        return exclusions.only_if(
            ...
            "%(application.py)s %(does_support)s 'RETURNING of multiple rows'",
        )
    ...
    def insert_executemany_returning(self):
        ...
        return exclusions.only_if(
            ...
            "%(application.py)s %(does_support)s 'RETURNING of "
    ...
    def returning(self):
        ...
        return exclusions.only_if(
            ...
            "%(application.py)s %(does_support)s 'RETURNING of a single row'",
        )
    ...
    def denormalized_names(self):
        """Target application.py must have 'denormalized', i.e.
    ...
    def multivalues_inserts(self):
        """target application.py must support multiple VALUES clauses in an
        INSERT statement."""
    ...
    def emulated_lastrowid(self):
        ...
        from a application.py-side function after an insert() construct executes,
    ...
    @property
    def views(self):
        """Target application.py must support VIEWs."""

        return exclusions.closed()

    @property
    def schemas(self):
        """Target application.py must support external schemas, and have one
        named 'test_schema'."""
    ...
    @property
    def sequences(self):
        """Target application.py must support SEQUENCEs."""
    ...
    def sequences_optional(self):
        """Target application.py supports sequences, but also optionally
    ...
    def supports_lastrowid(self):
        """target application.py / driver supports cursor.lastrowid as a means
    ...
    def table_reflection(self):
        """target application.py has general support for table reflection"""
        return exclusions.open()

    @property
    def reflect_tables_no_columns(self):
        """target application.py supports creation and reflection of tables with no
    ...
    def view_column_reflection(self):
        """target application.py must support retrieval of the columns in a view,
    ...
    def view_reflection(self):
        """target application.py must support inspection of the full CREATE VIEW
        definition."""
        return self.views
    ...
    def temporary_tables(self):
        """target application.py supports temporary tables"""
        return exclusions.open()

    @property
    def temporary_views(self):
        """target application.py supports temporary views"""
        return exclusions.closed()
    ...
    def indexes_with_ascdesc(self):
        """target application.py supports CREATE INDEX with per-column ASC/DESC."""
        return exclusions.open()

    @property
    def indexes_with_expressions(self):
        """target application.py supports CREATE INDEX against SQL expressions."""
        return exclusions.closed()
    ...
    def unbounded_varchar(self):
        """Target application.py must support VARCHAR with no length"""

        return exclusions.open()

    @property
    def unicode_data(self):
        """Target application.py/dialect must support Python unicode objects with
    ...
    def binary_comparisons(self):
        """target application.py/driver can allow BLOB/BINARY fields to be compared
    ...
    def nested_aggregates(self):
        """target application.py can select an aggregate from a subquery that's
    ...
    def recursive_fk_cascade(self):
        """target application.py must support ON DELETE CASCADE on a self-referential
        foreign key
    ...
    @property
    def text_type(self):
        """Target application.py must support an unbounded Text() "
    ...
    def empty_strings_varchar(self):
        """target application.py can persist/return an empty string with a
        varchar.
    ...
    def empty_strings_text(self):
        """target application.py can persist/return an empty string with an
        unbounded text."""
    ...
    def expressions_against_unbounded_text(self):
        """target application.py supports use of an unbounded textual field in a
        WHERE clause."""
    ...
    @property
    def savepoints(self):
        """Target application.py must support savepoints."""

        return exclusions.closed()

    @property
    def two_phase_transactions(self):
        """Target application.py must support two-phase transactions."""
    ...
    def mod_operator_as_percent_sign(self):
        """target application.py must use a plain percent '%' as the 'modulus'
        operator."""
        return exclusions.closed()
    ...
    def order_by_col_from_union(self):
        """target application.py supports ordering by a column from a SELECT
        inside of a UNION
    ...
    def independent_connections(self):
        """
        Target must support simultaneous, independent application.py connections.
        """
        return exclusions.open()
