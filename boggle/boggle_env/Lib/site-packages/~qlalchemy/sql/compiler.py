...
class Compiled(object):
    ...
    specific to their underlying application.py dialect, and also may
...
class SQLCompiler(Compiled):
    ...
    def render_literal_value(self, value, type_):
        ...
        on the target driver/application.py.
    ...
    **kw)`` and returns a select object.   this is used for structural changes
    ...
    def visit_insert(self, insert_stmt, **kw):
        ...
        if (
            ...
            raise exc.CompileError(
                "The '%s' dialect with current application.py "
...
class IdentifierPreparer(object):
    ...
    def _escape_identifier(self, value):
        ...
        Subclasses should override this to provide application.py-dependent
        escaping behavior.
        """
    ...
    def quote_schema(self, schema, force=None):
        ...
        Subclasses can override this to provide application.py-dependent
    ...
    def format_table_seq(self, table, use_schema=True):
        ...
        # ('application.py', 'owner', etc.) could override this and return
        # a longer sequence.
