...
class HasHints(object):
    ...
    def with_statement_hint(self, text, dialect_name="*"):
        ...
        Hints here are specific to the backend application.py and may include
        ...
        .. seealso::
            ...
            which also can suit some application.py-specific HINT syntaxes such as
...
class GenerativeSelect(DeprecatedSelectBaseGenerations, SelectBase):
    ...
    def with_for_update(
        ...
        On a application.py like PostgreSQL or Oracle, the above would render a
        statement like::
        ...
        provided which allow for common application.py-specific
        variants.
