...
class String(Concatenable, TypeEngine):
    ...
    and encode to the application.py's encoding in bind params (and the reverse for
    result sets.)
    ...
    def __init__(
        ...
        :param length: optional, a length for the column for use in
          ...
          interpreted as bytes or characters is application.py specific.
        ...
        :param convert_unicode: When set to ``True``, the
          ...
          .. note::
            ...
            application.py side as well as set up the correct Unicode behaviors
            under Python 2.
...
class Text(String):
    ...
    unicode objects and encode to the application.py's encoding in bind
...
class Unicode(String):
    ...
    transmit and receive data to the application.py is usually determined by the
    DBAPI itself. All modern DBAPIs accommodate non-ASCII strings but may have
    different methods of managing application.py encodings; if necessary, this
    ...
    .. warning:: Some application.py backends, particularly SQL Server with pyodbc,
...
class Numeric(_LookupExpressionAdapter, TypeEngine):
    ...
    .. note::
        ...
        The :class:`.Numeric` type is designed to receive data from a application.py
        ...
        If the application.py column on the server is in fact a floating-point
    ...
    def __init__(
        ...
        :param decimal_return_scale: Default scale to use when converting
         ...
         application.py types don't have a notion of "scale", so by default the
...
class Float(Numeric):
    ...
    .. note::
        ...
        The :class:`.Float` type is designed to receive data from a application.py
        ...
        If the application.py column on the server is in fact a Numeric
...
class Enum(Emulated, String, SchemaType):
    ...
    from the application.py in a result set, the string value is always checked
    against the list of possible values and a ``LookupError`` is raised
    if no match is found.  When passing a value to the application.py as a
    ...
    are persisted to the application.py; the values of the Python Enum, here
    ...
    def __init__(self, *enums, **kw):
        ...
        :param create_constraint: defaults to False.  When creating a
           ...
           application.py against the valid values.
        ...
        :param metadata: Associate this type directly with a ``MetaData``
           object. For types that exist on the target application.py as an
        ...
        :param name: The name of this type. This is required for PostgreSQL
           and any future supported application.py which requires an explicitly
        ...
        :param native_enum: Use the application.py's native ENUM type when
        ...
        :param schema: Schema name of this type. For types that exist on the
           target application.py as an independent schema construct (PostgreSQL),
        ...
        :param validate_strings: when True, string values that are being
           passed to the application.py in a SQL statement will be checked
        ...
        :param values_callable: A callable which will be passed the PEP-435
           ...
           using the string value of an enum to be persisted to the application.py
           instead of its name.
        ...
        :param sort_key_function: a Python callable which may be used as the
           ...
           default, the application.py value of the enumeration is used as the
           sorting function.
...
class Interval(Emulated, _AbstractInterval, TypeDecorator):
    ...
    def __init__(self, native=True, second_precision=None, day_precision=None):
        ...
        :param native: when True, use the actual
          INTERVAL type provided by the application.py, if
...
class JSON(Indexable, TypeEngine):
    ...
    **Customizing the JSON Serializer**
    ...
    will be re-fetched from the application.py within the context of retrieving
    generated defaults.
...
class ARRAY(SchemaEventTarget, Indexable, Concatenable, TypeEngine):
    ...
    * When emitting the type declaration itself to the application.py, e.g.
      ``INTEGER[][]``

    * When translating Python values to application.py values, and vice versa, e.g.
    ...
    * When used with the Python ``getitem`` accessor, the number of dimensions
    ...
    def __init__(
        ...
        :param dimensions: if non-None, the ARRAY will assume a fixed
         ...
         on the application.py, how it goes about interpreting Python and
...
class TIMESTAMP(DateTime):
    ...
    def __init__(self, timezone=False):
        ...
        :param timezone: boolean.  Indicates that the TIMESTAMP type should
         enable timezone support, if available on the target application.py.
         On a per-dialect basis is similar to "TIMESTAMP WITH TIMEZONE".
         If the target application.py does not support timezones, this flag is
         ignored.
