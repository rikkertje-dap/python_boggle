...
class UpdateBase(
    ...
    def returning(self, *cols):
        ...
        Upon compilation, a RETURNING clause, or application.py equivalent,
        ...
        read the documentation notes for the application.py in use in
    ...
    def with_hint(self, text, selectable=None, dialect_name="*"):
        ...
        location for the application.py backend in use, relative
...
class ValuesBase(UpdateBase):
    ...
    def values(self, *args, **kwargs):
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         method, which is supported by all application.py backends and is generally
    ...
    def return_defaults(self, *cols):
        ...
        4. An INSERT statement invoked with executemany() is supported if the
           backend application.py driver supports the
...
class Insert(ValuesBase):
    ...
    def from_select(self, names, select, include_defaults=True):
        ...
        :param select: a :func:`_expression.select` construct,
         ...
         is not checked before passing along to the application.py, the application.py
...
class DMLWhereBase(object):
    ...
    def where(self, *whereclause):
        ...
        support multiple-table forms, including application.py-specific
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        :param table: A :class:`_schema.Table`
         object representing the application.py
         table to be updated.
