...
class DDLElement(roles.DDLRole, Executable, _DDLCompiles):
    ...
    def execute_if(self, dialect=None, callable_=None, state=None):
        ...
        :param dialect: May be a string or tuple of strings.
          ...
          executing application.py dialect::
...
class DDL(DDLElement):
    ...
    Specifies literal SQL DDL to be executed by the application.py.  DDL objects
...
class DropTableComment(_CreateDropBase):
    ...
    Note this varies a lot across application.py backends.
