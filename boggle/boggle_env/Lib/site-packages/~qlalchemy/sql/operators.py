...
class ColumnOperators(Operators):
    ...
    def __getitem__(self, index):
        ...
        This can be used by some application.py-specific types
    ...
    def in_(self, other):
        ...
        * A bound parameter, e.g. :func:`.bindparam`, may be used if it
          ...
          The application.py would be passed a bound parameter for each value::
          ...
          which is specific to the application.py in use, is rendered.  On
    ...
    def startswith(self, other, **kwargs):
        ...
        :param escape: a character which when given will render with the
          ...
          ``"foo^%bar^^bat"`` before being passed to the application.py.
    ...
    def match(self, other, **kwargs):
        """Implements a application.py-specific 'match' operator.
    ...
    def regexp_match(self, pattern, flags=None):
        """Implements a application.py-specific 'regexp match' operator.
    ...
    def regexp_replace(self, pattern, replacement, flags=None):
        """Implements a application.py-specific 'regexp replace' operator.
