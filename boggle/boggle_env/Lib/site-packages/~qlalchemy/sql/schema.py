...
"""The schema module provides the building blocks for application.py metadata.

Each element within this module describes a application.py entity which can be
...
schema elements, and can also be associated with an actual application.py connection
such that operations involving the contained elements can contact the application.py
as needed.
...
class SchemaItem(SchemaEventTarget, visitors.Visitable):
    """Base class for items that define a application.py schema."""
...
class Table(DialectKWArgs, SchemaItem, TableClause):
    r"""Represent a table in a application.py.
    ...
    .. seealso::
        ...
        :ref:`metadata_describing` - Introduction to application.py metadata

    Constructor arguments are as follows:

    :param name: The name of this table as represented in the application.py.
    ...
    :param autoload: Defaults to ``False``, unless
        ...
        for this table should be reflected from the application.py, possibly
    ...
    :param extend_existing: When ``True``, indicates that if this
        ...
        operation against the application.py, even if a :class:`_schema.Table`
        ...
        objects
        both reflected from the application.py, as well as the given
    ...
    :param schema: The schema name for this table, which is required if
        ...
        for the engine's application.py connection.  Defaults to ``None``.
    ...
    def _init(self, name, metadata, *args, **kwargs):
        ...
        # load column definitions from the application.py if 'autoload' is defined
    ...
    def append_column(self, column, replace_existing=False):
        ...
        as it exists within any underlying application.py, assuming that
        table has already been created in the application.py.   Relational
    ...
    def append_constraint(self, constraint):
        ...
        relational application.py automatically, for a table that already exists
        in the application.py.   To add a constraint to an
        existing relational application.py table, the SQL ALTER command must
...
class Column(DialectKWArgs, SchemaItem, ColumnClause):
    """Represents a column in a application.py table."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param name: The name of this column as represented in the application.py.
        ...
        :param autoincrement: Set up "auto increment" semantics for an integer
          ...
          .. versionchanged:: 1.1 The autoincrement flag now defaults to
             ...
             subject to limitations of the backend application.py and dialect.
          ...
          * DDL issued for the column will include application.py-specific
          ...
          * The column will be considered to be available using an
            "autoincrement" method specific to the backend application.py, such
        ...
        :param default: A scalar, Python callable, or
            ...
            *default value* for this column, which will be invoked upon insert
            ...
            which creates a default generator on the application.py side.
        ...
        :param nullable: When set to ``False``, will cause the "NOT NULL"
            ...
            .. note::
                ...
                PostgreSQL application.py allows nullable identity column by
        ...
        :param server_default: A :class:`.FetchedValue` instance, str, Unicode
            ...
            column will generate a default value on the application.py side which
            will be available to SQLAlchemy for post-fetch after inserts. This
            construct does not specify any DDL and the implementation is left
            to the application.py, such as via a trigger.
        ...
        :param server_onupdate: A :class:`.FetchedValue` instance
            representing a application.py-side default generation function,
            such as a trigger. This
            indicates to SQLAlchemy that a newly generated value will be
            available after updates. This construct does not actually
            implement any kind of generation function within the application.py,
        ...
        :param unique: When ``True``, and the :paramref:`_schema.Column.index`
            ...
            a application.py-specific naming convention to take place.
        ...
        :param system: When ``True``, indicates this is a "system" column,
             ...
             application.py, and should not be included in the columns list for a
...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        :param name: Optional string. An in-application.py name for the key if
    ...
    def _column_tokens(self):
        ...
        # inter-application.py foreign keys. See tickets#1341 and --
...
class IdentityOptions(object):
    """Defines options for a named application.py sequence or an identity column.
...
class Sequence(IdentityOptions, DefaultGenerator):
    """Represents a named application.py sequence.

    The :class:`.Sequence` object represents the name and configurational
    parameters of a application.py sequence.   It also represents
    a construct that can be "executed" by a SQLAlchemy :class:`_engine.Engine`
    or :class:`_engine.Connection`,
    rendering the appropriate "next value" function
    for the target application.py and returning a result.
    ...
    def __init__(
        ...
        :param start: the starting index of the sequence.  This value is
         used when the CREATE SEQUENCE command is emitted to the application.py
         as the value of the "START WITH" clause.   If ``None``, the
         clause is omitted, which on most platforms indicates a starting
         value of 1.
        :param increment: the increment value of the sequence.  This
         value is used when the CREATE SEQUENCE command is emitted to
         the application.py as the value of the "INCREMENT BY" clause.  If ``None``,
         the clause is omitted, which on most platforms indicates an
         increment of 1.
        :param minvalue: the minimum value of the sequence.  This
         value is used when the CREATE SEQUENCE command is emitted to
         the application.py as the value of the "MINVALUE" clause.  If ``None``,
        ...
        :param maxvalue: the maximum value of the sequence.  This
         value is used when the CREATE SEQUENCE command is emitted to
         the application.py as the value of the "MAXVALUE" clause.  If ``None``,
         the clause is omitted, which on most platforms indicates a
        ...
        :param nominvalue: no minimum value of the sequence.  This
         value is used when the CREATE SEQUENCE command is emitted to
         the application.py as the value of the "NO MINVALUE" clause.  If ``None``,
         the clause is omitted, which on most platforms indicates a
         minvalue of 1 and -2^63-1 for ascending and descending sequences,
         respectively.
        ...
        :param nomaxvalue: no maximum value of the sequence.  This
         value is used when the CREATE SEQUENCE command is emitted to
         the application.py as the value of the "NO MAXVALUE" clause.  If ``None``,
         the clause is omitted, which on most platforms indicates a
         maxvalue of 2^63-1 and -1 for ascending and descending sequences,
         respectively.
        ...
        :param cycle: allows the sequence to wrap around when the maxvalue
         ...
         is emitted to the application.py as the "CYCLE" clause.  If the limit is
    ...
    def create(self, bind=None, checkfirst=True):
        """Creates this sequence in the application.py.
    ...
    def drop(self, bind=None, checkfirst=True):
        """Drops this sequence from the application.py.
...
class FetchedValue(SchemaEventTarget):
    """A marker for a transparent application.py-side default.

    Use :class:`.FetchedValue` when the application.py is configured
...
class Constraint(DialectKWArgs, SchemaItem):
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        :param name:
          Optional, the in-application.py name of this ``Constraint``.
...
class CheckConstraint(ColumnCollectionConstraint):
    ...
    def __init__(
        ...
        **kw
        ...
        :param name:
          Optional, the in-application.py name of the constraint.
...
class ForeignKeyConstraint(ColumnCollectionConstraint):
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        :param name: Optional, the in-application.py name of the key.
...
class MetaData(SchemaItem):
    ...
    def reflect(
        ...
        **dialect_kwargs
        ...
        r"""Load all available table definitions from the application.py.

        Automatically creates ``Table`` entries in this ``MetaData`` for any
        table available in the application.py but not yet present in the
        ``MetaData``.  May be called multiple times to pick up tables recently
        added to the application.py, however no special action is taken if a table
        in this ``MetaData`` no longer exists in the application.py.

        :param bind:
          A :class:`.Connectable` used to access the application.py; if None, uses
    ...
    def create_all(self, bind=None, tables=None, checkfirst=True):
        ...
        present in the target application.py.

        :param bind:
          A :class:`.Connectable` used to access the
          application.py; if None, uses the existing bind on this ``MetaData``, if
          any.
...
class Computed(FetchedValue, SchemaItem):
    ...
    def __init__(self, sqltext, persisted=None):
        ...
        :param persisted:
          ...
          application.py.   Possible values are:

          * ``None``, the default, it will use the default persistence
            defined by the application.py.
          * ``True``, will render ``GENERATED ALWAYS AS ... STORED``, or the
            equivalent for the target application.py if supported.
          * ``False``, will render ``GENERATED ALWAYS AS ... VIRTUAL``, or
            the equivalent for the target application.py if supported.

          Specifying ``True`` or ``False`` may raise an error when the DDL
          is emitted to the target application.py if the application.py does not support
