...
"""private module containing functions used to convert application.py
...
def load_on_ident(
    ...
    """Load the given identity key from the application.py."""
    if key is not None:
        ident = key[1]
...
def load_on_pk_identity(
    ...
    """Load the given primary key identity from the application.py."""
...
def _validate_version_id(mapper, state, dict_, row, getter):
    ...
    if mapper._get_state_attr_by_column(
        ...
        raise orm_exc.StaleDataError(
            ...
            "does not match application.py-loaded version id '%s'."
            % (
                state_str(state),
