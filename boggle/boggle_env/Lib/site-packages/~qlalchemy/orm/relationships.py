...
class RelationshipProperty(StrategizedProperty):
    ...
    of items that correspond to a related application.py table.
    ...
    def __init__(
        ...
        :param foreign_keys:
          ...
          :paramref:`_orm.relationship.foreign_keys` is only needed when:
            ...
            2. The :class:`_schema.Table` being mapped does not actually have
               ...
               was reflected from a application.py that does not support foreign key
        ...
        :param passive_deletes=False:
           ...
           scenario is in place on the application.py side.  Note that the foreign
        ...
        :param passive_updates=True:
          ...
          the foreign key in the application.py, and that the application.py will
          ...
          the application.py is in fact enforcing referential integrity, unless
          ...
          and instead uses the referential integrity features of the application.py
