...
construct used by the ORM to construct application.py queries.

The :class:`_query.Query` class should not be confused with the
:class:`_expression.Select` class, which defines application.py
SELECT operations at the SQL (non-ORM) level.  ``Query`` differs from
``Select`` in that it returns ORM-mapped objects and interacts with an
ORM session, whereas the ``Select`` construct interacts directly with the
application.py to return iterable result sets.
...
class Query(
    ...
    def with_for_update(
        ...
        .. warning::
            ...
            application.py backends.  When ``with_for_update`` is successfully used
    ...
    def union(self, *q):
        ...
        Note that many application.py backends do not allow ORDER BY to
    ...
    def join(self, target, *props, **kwargs):
        ...
        **Simple Relationship Joins**
        ...
        .. note:: as seen in the above example, **the order in which each
           ...
           SQL in which case the application.py will raise an error. In correct
           practice, the
    ...
    def distinct(self, *expr):
        ...
        .. note::
            ...
            of the application.py backend that ORDER BY columns be part of the SELECT
    ...
    def delete(self, synchronize_session="evaluate"):
        ...
        Deletes rows matched by this query from the application.py.
        ...
        :return: the count of rows matched as returned by the application.py's
          "row count" feature.
    ...
    def update(self, values, synchronize_session="evaluate", update_args=None):
        ...
        Updates rows matched by this query in the application.py.
