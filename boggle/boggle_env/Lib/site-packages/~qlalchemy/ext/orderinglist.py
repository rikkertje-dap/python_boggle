...
collection, and not the initial load from the application.py, and requires that the
...
class OrderingList(list):
    ...
    def __init__(
        ...
        :param reorder_on_append:
          ...
          variety of dangerous unexpected application.py writes.

          SQLAlchemy will add instances to the list via append() when your
          object loads.  If for some reason the result set from the application.py
