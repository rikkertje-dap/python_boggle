...
class Connection(_LegacyConnection):
    ...
    * The :class:`_future.Connection` object does not support "branching",
    ...
    def begin(self):
        ...
        From a application.py point of view, the :meth:`_future.Connection.begin`
    ...
    def begin_nested(self):
        ...
        containing application.py transaction itself, and not the SAVEPOINT itself.
        When a application.py transaction is committed, any SAVEPOINTs that have been
    ...
    def commit(self):
        ...
        .. note:: The :meth:`_future.Connection.commit` method only acts upon
          the primary application.py transaction that is linked to the
    ...
    def rollback(self):
        ...
        .. note:: The :meth:`_future.Connection.rollback` method only acts
          upon the primary application.py transaction that is linked to the
          :class:`_future.Connection` object.  It does not operate upon a
          SAVEPOINT that would have been invoked from the
          :meth:`_future.Connection.begin_nested` method; for control of a
