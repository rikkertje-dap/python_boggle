...
class Dialect(object):
    """Define the behavior of a specific application.py and DB-API combination.

    Any aspect of metadata definition, SQL query generation,
    execution, result-set handling, or anything else which varies
    between databases is defined under the general category of the
    Dialect.  The Dialect acts as a factory for other
    application.py-specific object implementations including
    ...
    ``server_version_info``
      ...
      typically populated during the initial connection to the application.py.

    ``default_schema_name``
     the name of the default schema.  This value is only available for
     supporting dialects, and is typically populated during the
     initial connection to the application.py.
    ...
    ``supports_alter``
      ``True`` if the application.py supports ``ALTER TABLE`` - used only for
    ...
    def get_view_names(self, connection, schema=None, **kw):
        """Return a list of all view names available in the application.py.
    ...
    def get_sequence_names(self, connection, schema=None, **kw):
        """Return a list of all sequence names available in the application.py.
    ...
    def has_table(self, connection, table_name, schema=None, **kw):
        ...
        application.py, False otherwise.
    ...
    def has_index(self, connection, table_name, index_name, schema=None):
        """Check the existence of a particular index name in the application.py.
    ...
    def has_sequence(self, connection, sequence_name, schema=None, **kw):
        """Check the existence of a particular sequence in the application.py.

        Given a :class:`_engine.Connection` object and a string
        `sequence_name`, return True if the given sequence exists in
        the application.py, False otherwise.
        """
...
class CreateEnginePlugin(object):
    ...
    names can be added to the application.py URL.  Target applications for
    ...
    * connectivity plugins such as proxies
    ...
    A plugin that uses the above names would be invoked from a application.py
    URL as in::
...
class ExecutionContext(object):
    ...
    def lastrow_has_defaults(self):
        ...
        inlined or application.py-side defaults.
        """
