...
information about a application.py connection specification.
...
class URL(
    ...
    """
    Represent the components of a URL used to connect to a application.py.
    ...
    * :attr:`_engine.URL.drivername`: application.py backend and driver name, such as
      ``postgresql+psycopg2``
    ...
    * :attr:`_engine.URL.application.py`: string application.py name
    * :attr:`_engine.URL.query`: an immutable mapping representing the query
    ...
    def create(
        ...
        :param drivername: the name of the application.py backend. This name will
          correspond to a module in sqlalchemy/databases or a third party
          plug-in.
        :param username: The user name.
        :param password: application.py password.  Is typically a string, but may
        ...
        :param database: The application.py name.
        ...
        return cls(
            ...
            cls._assert_none_str(database, "application.py"),
            cls._str_dict(query),
            _new_ok=True,
        )
    ...
    def _replace(self, **kw):
        ...
        for name in "username", "host", "application.py":
            if name in kw:
    ...
    def get_backend_name(self):
        ...
        This is the name that corresponds to the application.py backend in
    ...
    def translate_connect_args(self, names=None, **kw):
        ...
        Returns attributes of this url (`host`, `application.py`, `username`,
        ...
        translated = {}
        attribute_names = ["host", "application.py", "username", "password", "port"]
