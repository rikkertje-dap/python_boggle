...
class ConnectionEvents(event.Events):
    ...
    to the application.py.  The :meth:`.before_cursor_execute` event is
    ...
    def before_execute(
        ...
        as early manipulation of the parameters being sent to the application.py,
    ...
    def engine_connect(self, conn, branch):
        ...
        refers to the actual connection to a application.py at the DBAPI level;
