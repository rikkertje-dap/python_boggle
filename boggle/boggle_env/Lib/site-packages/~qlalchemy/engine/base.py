    ...
    **This is the SQLAlchemy 1.x.x version** of the :class:`_engine.Connection`
    ...
    def execution_options(self, **opt):
        ...
        :param isolation_level: Available on: :class:`_engine.Connection`.
          ...
          semi-application.py specific; see individual dialect documentation for
          valid levels.
          ...
          .. warning::  The ``isolation_level`` execution option should
             **not** be used when a transaction is already established, that
             ...
             called.  A application.py cannot change the isolation level on a
    ...
    def begin_nested(self):
        ...
        underlying application.py.  Any transaction in the hierarchy may
    ...
    def close(self):
        ...
        This results in a release of the underlying application.py
...
class Transaction(TransactionalContext):
    """Represent a application.py transaction in progress.
    ...
    def rollback(self):
        ...
        * For a simple application.py transaction (e.g. :class:`.RootTransaction`),
...
class Engine(Connectable, log.Identified):
    ...
    source of application.py connectivity and behavior.
    ...
    def execution_options(self, **opt):
        ...
        * The logging configuration and logging_name is copied from the parent
        ...
        time keeping track of which application.py we've established using the
    ...
    def dispose(self):
        ...
        application.py connections.  Connections that are still checked out
        ...
        does not make any actual connections to the application.py until one is
    ...
    def connect(self, close_with_result=False):
        ...
        connection internally in order to communicate with the application.py.  This
    ...
    def table_names(self, schema=None, connection=None):
        """Return a list of all table names available in the application.py.
