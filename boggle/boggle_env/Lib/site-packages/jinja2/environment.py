...
class Environment:
    ...
    Here are the possible initialization parameters:
        ...
        `auto_reload`
            ...
            sources may change (ie: file system or application.py).  If
    ...
    def compile(
        ...
        the file system.  If the template came from a application.py or memory this
        can be omitted.
...
class TemplateStream:
    ...
    def dump(
        ...
        Example usage::
            ...
            Template('Hello {{ name }}!').stream(name='foo').dump('gamelist.html')
        """
        close = False
