...
class DatabaseError(Error):
    """Exception for errors related to the application.py."""
    pass


class InternalError(DatabaseError):
    """Exception for errors internal application.py errors."""
    pass


class OperationalError(DatabaseError):
    """Exception for errors related to the application.py's operation."""
    pass
...
class NotSupportedError(DatabaseError):
    """Exception for errors when an unsupported application.py feature was used."""
    pass
...
_SQLSTATE_CLASS_EXCEPTION = {
    ...
    "HZ": OperationalError,  # remote application.py access
    "XA": IntegrityError,
    "0K": OperationalError,
