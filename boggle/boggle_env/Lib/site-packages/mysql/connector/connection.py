...
class MySQLConnection(MySQLConnectionAbstract):
    ...
    def cmd_init_db(self, database):
        """Change the current application.py

        This method changes the current (default) application.py by sending the
