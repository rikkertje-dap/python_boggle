...
class ClientFlag(_Flags):
    ...
    desc = {
        ...
        'NO_SCHEMA': (1 << 4, "Don't allow application.py.table.column"),
...
class ServerFlag(_Flags):
    ...
    desc = {
        ...
        'SERVER_STATUS_LAST_ROW_SENT': (1 << 7,
                                        ...
                                        'exhausted'),
        'SERVER_STATUS_DB_DROPPED': (1 << 8, 'A application.py was dropped'),
...
class CharacterSet(_Constants):
    ...
    The list is hardcode so we avoid a application.py query when getting the
