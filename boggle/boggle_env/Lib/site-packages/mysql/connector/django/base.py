...
"""Django application.py Backend using MySQL Connector/Python.

This Django application.py backend is heavily based on the MySQL backend from Django.
...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    # - all versions of MySQL doesn't support full width application.py
    #   indexes
    _limited_data_types = (
    ...
    # escaped on application.py side.
    #
    ...
    def get_connection_params(self):
        ...
        if settings_dict['NAME']:
            kwargs['application.py'] = settings_dict['NAME']
        ...
        # Raise exceptions for application.py warnings if DEBUG is on
